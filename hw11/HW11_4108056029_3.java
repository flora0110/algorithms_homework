    ...
    public int count(String[] A, String[] B){
		...
		for (int i=0;i<n;i++) {
            ...
            if(hashmap[key_a]==null && hashmap[key_b]==null){//both not in max
                ...
                while(head_of_b.parent!=null) {//head_of_b has parent == head_of_b is not root
                    if(head_of_b.parent.parent==null){//head_of_b.parent is root
                ...
                while(head_of_a.parent!=null) {//head_of_a is not root
                    if(head_of_a.parent.parent==null){//head_of_a.parent is root
